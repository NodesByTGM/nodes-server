...
router.get('/registered', AuthMiddlewares.isAuthenticated, eventControllers.getRegisteredEvents);
...
router.post('/register/:id', AuthMiddlewares.isAuthenticated, eventControllers.registerToEvent);
